      ...
      <div class="doctor-card">
        ...
        <div class="doctor-info" style="margin-left: 15px; margin-top: 20px">
          <img
            ...
            src="../../assets/imgs/doctor-picture.png"
          />
          <p style="overflow: scroll" class="introduction">
            个人简介<br /><br />
        ...
        <div class="table-title">
          <p style="width: 4vw; overflow: hidden" class="table-list">
            患者姓名
          </p>
          <p
            style="margin-left: 8%; width: 4vw; overflow: hidden"
            class="table-list"
          >
            手机号码
          </p>
        ...
        <div class="patient-list">
          <div
            style="margin-left: 5%; display: flex; flex-direction: row"
            v-for="item in patients"
          >
            <div class="table-list">{{ item.name }}</div>
            <div
              style="margin-left: 15%; width: 6vw; overflow: hidden"
              class="table-list"
            >
              {{ item.num }}
            </div>
            <div
              style="margin-left: 10%; width: 4vw; overflow: hidden"
              class="table-list"
            >
              {{ item.type }}
            </div>
          ...
          >
            ...
            <el-col :span="18" style="padding: 2%; background-color: #20252a">
              <table style="width: 100%; text-align: justify">
                <tr>
                  <td>
                    患者姓名<label style="color: #a2a1a7; margin-left: 5%">{{
                      item.patientName
                    }}</label>
                  </td>
                  <td>
                    既往病史<label style="color: #a2a1a7; margin-left: 5%">{{
                      item.pastMedicalHistory
                    }}</label>
                  </td>
                  <td>
                    术前评估<label style="margin-left: 5%">{{
                      item.preEvaluation
                    }}</label>
                  </td>
                </tr>
                ...
                <tr>
                  <td>
                    患者性别<label style="color: #a2a1a7; margin-left: 5%">{{
                      item.patientGender
                    }}</label>
                  </td>
                  <td>
                    慢性病史<label style="color: #a2a1a7; margin-left: 5%">{{
                      item.chronicMedicalHistory
                    }}</label>
                  </td>
                  <td>
                    术前检查<label style="color: #a2a1a7; margin-left: 5%">{{
                      item.preExamination
                    }}</label>
                  </td>
                </tr>
                ...
                <tr>
                  <td>
                    患者年龄<label style="color: #a2a1a7; margin-left: 5%">{{
                      item.patientAge
                    }}</label>
                  </td>
                  <td>
                    药物过敏<label style="color: #a2a1a7; margin-left: 5%">{{
                      item.pastMedicalHistory
                    }}</label>
                  </td>
                  <td>
                    <el-button size="large" type="warning" plain
                      >诊断报告</el-button
                    >
                  </td>
                </tr>
                ...
                <tr>
                  <td>
                    患者血型<label style="color: #a2a1a7; margin-left: 5%">{{
                      item.patientBlood
                    }}</label>
                  </td>
                  <td>
                    不良反应<label style="color: #a2a1a7; margin-left: 5%">{{
              ...
              <el-row style="overflow: scroll">
                <el-button size="large" type="warning" :icon="Document" plain
                  >患者病历.pdf</el-button
                >
                <el-button size="large" type="warning" :icon="Document" plain
                  >术前完整报告.pdf</el-button
                >
                <el-button size="large" type="warning" :icon="Document" plain
                  >麻醉知情同意书.pdf</el-button
                >
              </el-row>
            </el-col>
