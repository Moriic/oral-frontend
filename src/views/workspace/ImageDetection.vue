...
import {Back, Crop, Edit, EditPen, Scissor} from "@element-plus/icons-vue";
...
<template>
  <div style="background-color: #604085;height: 100%;width: 100%;display: flex;flex-direction: column;">
    <title-bar>
      <el-button @click="backPage" class="backButton" size="large" :icon="Back" round>返回</el-button>
    </title-bar>
      ...
      <div class="patient-info">
        <div style="width: 100%;color: white;margin-left: 22px;">
          ...
          <button style="margin-left: 65%;background-color: transparent;border: 0">
            <img style="background-color: #604085;width: 12px;height: auto"
